...
- registry v2 保留原 v1 的完整能力组合：Darwin 25.3.0（macOS 26.3 build 25D125）、Xcode 26.4 build 17E192、`com.apple.CoreSimulator.SimRuntime.iOS-26-4` build 23E244、arm64；新增 Darwin 27.0.0、Xcode 27.0 build 27A266a、iOS 27.0 build 24A434、arm64 的 **Sidecar/H.264/continuousInput/multiTouch** 准入。触控修复使用当前屏幕 ID 寻址，单指、双指、取消和崩溃恢复均经过 functional App 验证，而不是仅凭 transport 握手。框架布局兼容、逐项测试和未通过项见 [Xcode 27 兼容验证](ios-simulator-xcode27-compatibility.md)。两条记录均不外推到其它 OS、Xcode、runtime build 或架构；运行时 unknown 仍允许探测。
